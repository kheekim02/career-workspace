...
const NODES = [
  ...
  { id: "gka", group: "org", label: "Global Key Advisors",
    desc: "Financial Data Analyst (Jan 2026–Present). Built SEC data pipelines, a PostgreSQL research warehouse, NLP/graph systems for quant research, and a startup-success scoring AI with UC Davis CS on Cleantech Open data.",
    desc_ko: "재무 데이터 분석가 (2026년 1월–현재). SEC 데이터 파이프라인, PostgreSQL 연구 웨어하우스, 퀀트 리서치용 NLP/그래프 시스템, Cleantech Open 데이터 기반 UC Davis CS와의 스타트업 성공 예측 AI를 구축했습니다.",
    meta: ["Jan 2026 – Present", "Data Engineering", "Quant Research"] },
  { id: "ucdavis", group: "org", label: "UC Davis CS",
    desc: "Research collaboration with Prof. Vladimir Filkov on an AI system that scores early-stage startup success likelihood from engineered features on Cleantech Open accelerator data.",
    desc_ko: "Vladimir Filkov 교수와 Cleantech Open 액셀러레이터 데이터의 엔지니어링된 특성으로 초기 스타트업 성공 가능성을 점수화하는 AI 시스템 연구 협업.",
    meta: ["Prof. Vladimir Filkov", "Startup scoring", "Feature engineering"] },
  ...
  { id: "cleantech", group: "project", label: "Startup Scoring",
    desc: "AI system that predicts startup success likelihood from engineered features on Cleantech Open data — the world's largest cleantech accelerator (2,100+ ventures). Built with UC Davis CS (Prof. Vladimir Filkov); drawing interest from a Japanese national accelerator.",
    desc_ko: "Cleantech Open 데이터의 엔지니어링된 특성으로 스타트업 성공 가능성을 예측하는 AI 시스템 — 세계 최대 클린테크 액셀러레이터(2,100+ 벤처). UC Davis CS(Vladimir Filkov 교수)와 공동 구축, 일본 국가 액셀러레이터 관심 유치.",
    meta: ["Feature engineering", "Cleantech Open", "UC Davis"], link: "https://www.cleantechopen.org/" },
...
const LINK_DEFS = [
  ["me","gka","works at"], ["me","berkeley","studied at"], ["me","ucdavis","collaborated"],
  ["me","alpha","built"], ["me","pathwise","built"], ["me","fnf","researched"],
  ["me","football","built"], ["me","harmony","built"], ["me","cleantech","built"],
  ["gka","alpha","powers"], ["gka","cleantech","powers"],
  ["ucdavis","cleantech","collaborated on"],
  ["berkeley","fnf","hosts"], ["berkeley","pathwise","incubated"],
  ["alpha","python","uses"], ["alpha","postgres","uses"], ["alpha","neo4j","uses"],
  ["alpha","ml","uses"], ["alpha","spark","uses"], ["alpha","infra","uses"],
  ["cleantech","python","uses"], ["cleantech","ml","uses"], ["cleantech","sql","uses"],
...
const NODE_GLYPHS = {
  me: "◎", gka: "⌂", berkeley: "▣", ucdavis: "▣",
  alpha: "◈", cleantech: "◈", pathwise: "◉", fnf: "◆", football: "◐", harmony: "◑",
